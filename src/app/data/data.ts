...
export const AboutData: PageData = {
  aboutHreder: "Cześć!",
  aboutDescription:
    "Nazywam się Piotr Krysiak. Jestem studentem Informatyki. Specjalizacja: Programowanie Aplikacji Internetowych. Aktualnie zajmuję się głównie nauką React TypeSrcipt oraz .Net",
  aboutImg:
